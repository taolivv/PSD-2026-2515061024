...
def main():
    ...
    hashmap.insert(1, "Shinta")
    hashmap.insert(11, "Olivia")
    hashmap.insert(21, "Tata")
    hashmap.insert(2, "Olip")
    hashmap.display()

    hasil = int(input("Masukkan NPM: ")) 
    hasil = hashmap.search(hasil)
    if hasil is not None:
        print(f"\nMahasiswa dengan NPM tersebut bernama {hasil.value}")
    else:
